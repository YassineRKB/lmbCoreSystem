 ...
 * Custom Post Types
 *
 * Registers custom post types for LMB plugin.
 *
 * @package LMB Core
 */
...
class LMB_CPT {
    ...
    public static function register_post_types() {
        register_post_type('lmb_legal_ad', [
            'labels' => [
                ...
                'add_new_item' => __('Add New Legal Ad', 'lmb-core'),
            ],
            'public' => true,
            'show_ui' => true,
        ...
        register_post_type('lmb_newspaper', [
            'labels' => [
                ...
                'add_new_item' => __('Upload New Newspaper', 'lmb-core'),
            ],
            'public' => true,
            'show_ui' => true,
            'show_in_menu' => 'lmb-core',
        ...
        register_post_type('lmb_payment', [
            'labels' => [
                'name' => __('Payments', 'lmb-core'),
                'singular_name' => __('Payment', 'lmb-core'),
            ],
            'public' => false,
            'show_ui' => true,
            'show_in_menu' => 'lmb-core',
        ...
        register_post_type('lmb_package', [
            'labels' => [
                ...
                'add_new_item' => __('Add New Package', 'lmb-core'),
            ],
            'public' => false,
            'show_ui' => true,
            'show_in_menu' => 'lmb-core',
        ...
        register_post_type('lmb_invoice', [
            'labels' => [
                ...
                'add_new_item' => __('Add New Invoice', 'lmb-core'),
            ],
            'public' => false,
            'show_ui' => true,
            'show_in_menu' => 'lmb-core',
    ...
    public static function render_package_metabox($post) {
        ...
        <table class="form-table">
            ...
            <tr>
                <th><label for="lmb_cost_per_ad"><?php _e('Cost Per Ad', 'lmb-core'); ?></label></th>
